...
"""
Make csv of cost data for all load zones for a specified scenario
"""
...
# reorder columns
total_df = total_df[['scenario', 'load_zone', 'period', 'Cost Component', 'Cost']]

# save csv
filename = sel_scenario + '_cost_data_all_zones.csv'
